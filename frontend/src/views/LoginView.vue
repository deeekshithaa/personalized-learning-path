  ...
  methods: {
    async handleLogin() {
      try {
        ...
        // The magic: Save the token from the response to the browser's local storage
...
<style scoped>
/* You can copy the styles from RegisterView.vue or create new ones */
.login-container { display: flex; justify-content: center; align-items: center; padding: 2rem; }
.login-form { width: 100%; max-width: 400px; padding: 2rem; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); background-color: #f9f9f9; }
